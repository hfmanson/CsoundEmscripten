...
// {{PRE_LIBRARY}}
  ...
  function _csoundRunCommand() {
  Module['printErr']('missing function: csoundRunCommand'); abort(-1);
  }
  ...
  function _csoundSleep() {
  Module['printErr']('missing function: csoundSleep'); abort(-1);
  }
...
var _CsoundObj_start = Module["_CsoundObj_start"] = function() { return Module["asm"]["_CsoundObj_start"].apply(null, arguments) };
...
var _CsoundObj_compileOrcSco = Module["_CsoundObj_compileOrcSco"] = function() { return Module["asm"]["_CsoundObj_compileOrcSco"].apply(null, arguments) };
